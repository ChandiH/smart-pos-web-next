  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="h-9 px-2 py-0 border rounded-full hover:bg-accent hover:text-accent-foreground border-greenxborder bg-greenxbg text-greenx"
        >
          <User />
        </Button>
      </DropdownMenuTrigger>
        ...
        <div className="container mx-auto flex h-16 max-w-screen-2xl items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="flex flex-col">
              <span className="text-xs">{moment().format("dddd")}</span>
              <span className="text-lg">{moment().format("MMMM Do YYYY")}</span>
            </div>
            <div
